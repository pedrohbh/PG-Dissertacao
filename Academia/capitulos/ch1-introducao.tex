...
Todos os algoritmos estudados foram implementados na linguagem Java, versão 1.8.0\_131. Os testes a serem realizados e as instâncias utilizadas estão descritos no capítulo \ref{sec-testes}. A configuração do computador onde os testes foram realizados é o seguinte: o sistema operacional é o Linux Mint 18.2 Sonya 64-bit. O computador possui processador Intel Core i5-2430M @ 2.40 GHz. cache 6MB, memória de 4.0 GB e a versão do compilador Java utilizado é Javac 1.8.0\_131.
\newpage
