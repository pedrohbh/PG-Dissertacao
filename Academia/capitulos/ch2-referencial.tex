...
Para a realização dos experimentos computacionais será rodado instâncias de grafos que representam malhas rodoviárias reais. São elas:
\begin{table}
...
Todas essas instâncias estão disponíveis no sítio eletrônico \url{http://www.dis.uniroma1.it/challenge9/download.shtml} (acesso em 28 de janeiro de 2017).
\section{Conclusões}
