...
As versões são o Dijkstra Canônico, Dijkstra Heap Binário (seção X) e Dijkstra Heap de Fibonacci, todas descritas em \citeonline{cormen2009introduction, drozdek2012data}.
